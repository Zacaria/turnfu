...
test("maps resources to Wakfuli stat icons", () => {
...
test("maps combat stats to Wakfuli stat icons", () => {
...
test("maps Wakfuli aptitude ids to their original icon types", () => {
...
test("uses element-specific Wakfuli mastery icons", () => {
