...
const activeSpellEntries: DslEntry[] = [
  spell("mur-energie", {
    ...
    constraints: [cooldownTurns(2), requiresTarget("emptyCell")],
    tags: ["neutral", "summon"],
  ...
  spell("runification", {
    ...
    constraints: [
      maxCastsPerTurn(1),
      customConstraint("Le sort coute 40 BQ par rune possedee."),
    ],
  ...
  spell("ombres-dansantes", {
    ...
    constraints: [maxCastsPerTarget(2), maxCastsPerTurn(3)],
    tags: ["air", "movement"],
    metadata: extracted(screenshots.airAndLight),
  }),
  spell("papillons-diurnes", {
    ...
    constraints: [maxCastsPerTarget(3), maxCastsPerTurn(4)],
    tags: ["air", "movement"],
  ...
  spell("halo-chatoyant", {
    ...
    constraints: [maxCastsPerTarget(1), maxCastsPerTurn(3)],
    tags: ["light", "mark"],
  ...
  spell("rayon-crepusculaire", {
    ...
    constraints: [maxCastsPerTarget(2)],
  ...
  spell("lueur-de-laube", {
    ...
    constraints: [maxCastsPerTarget(2), maxCastsPerTurn(4)],
  ...
  spell("vestige", {
    ...
    constraints: [
      maxCastsPerTurn(2),
      customConstraint("Doit cibler un combattant ou un Feu-Follet."),
    ],
